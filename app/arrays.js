...
//4. Flights from Boise. Write a function that will use the following data to return the 
//cost of flights from boise to a neighboring city, by default return the standard cost 
//unless firstClass is set to true
...
function flightCost(destination, firstClass) {
    ...
    const found = flights.find(i => i.to == destination.toUpperCase())
...
// 5. Given a number, return the corresponding user object from the staff array that has 
//the given number as the value of their id property.If no user is found, return an 
